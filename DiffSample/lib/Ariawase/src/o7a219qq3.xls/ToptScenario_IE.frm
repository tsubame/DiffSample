VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} ToptScenario_IE 
   Caption         =   "InstanceEditor"
   ClientHeight    =   9630
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   12150
   OleObjectBlob   =   "ToptScenario_IE.frx":0000
   StartUpPosition =   1  'ÉIÅ[ÉiÅ[ ÉtÉHÅ[ÉÄÇÃíÜâõ
End
Attribute VB_Name = "ToptScenario_IE"
...
'äTóv:
'   Image Test ScenarioópÉCÉìÉXÉ^ÉìÉXÉGÉfÉBÉ^
'
'ñ⁄ìI:
'   Eee-JOB ImageTestScenarioÉeÉXÉgÉCÉìÉXÉ^ÉìÉXÉtÉåÅ[ÉÄÉèÅ[ÉNópÇ…êÍópÉCÉìÉXÉ^ÉìÉXÉGÉfÉBÉ^ÇçÏê¨
...
Private Sub ParameterSetup()
    ...
    '------------------------------------------------------------------------------------
    'Eee-JOB ImageTestScenarioÉCÉìÉXÉ^ÉìÉXÉGÉfÉBÉ^ópèàóùïœçX
...
'    End If
    ...
    With Me
        If .ReqPages.UserPage1.Visible Then
            .ReqPages.UserPage1.Caption = "Parameters"
        End If
    End With
    With tl_tm_ParUserReq1
        Set .DataBox = UserReqTextBox1
        Set .LabelBox = UserReqLabel1
    End With
    With tl_tm_ParUserReq2
        Set .DataBox = UserReqTextBox2
        Set .LabelBox = UserReqLabel2
    End With
    '#####  ÉpÉâÉÅÅ[É^ägí£  #####
...
Private Sub UserForm_Initialize()
    ...
    '------------------------------------------------------------------------------------
    'Eee-JOB ImageTestScenarioÉCÉìÉXÉ^ÉìÉXÉGÉfÉBÉ^ópèàóùïœçX
    'Image Test ScenarioêÍópÉGÉfÉBÉ^ÇÃÇΩÇﬂÇÃÉRÉìÉgÉçÅ[ÉãäeéÌÇÃê›íËÇí«â¡
'    IECustomForDCTestScenario
    IECustomForImageTestScenario ' ÉpÉâÉÅÅ[É^ägí£
    '------------------------------------------------------------------------------------
...
'            .Caption = "DC Test Scenario Execute Arguments"
            .Caption = "Topt Scenario Execute Arguments"
            .width = 396
            .height = 120
            .Top = 6
            .Left = 6
...
Private Sub IECustomForImageTestScenario()
'ì‡óe:
'   Eee-JOB Image Test ScenarioÇÃÇΩÇﬂÇÃÉGÉfÉBÉ^ÉtÉHÅ[ÉÄêÆå`
'   åªíiäKÇ≈ïsóvÇ»ÉRÉìÉgÉçÅ[ÉãÇÃîÒï\é¶Ç∆ÉTÉCÉYÅAà íuí≤êÆÇÃê›íË
'
'ÉpÉâÉÅÅ[É^:
'
...
'
    With Me
        .height = 365
        .width = 415
        .RequiredFrame.Visible = True
        With .RequiredFrame
            .Font.Name = "Tahoma"
            .Font.Size = 8
            .Caption = "Topt Frame Work Required Arguments"
            .width = 396
            .height = 120
            .Top = 6
            .Left = 6
        ...
        With .OptionalFrame
            .Font.Name = "Tahoma"
            .Font.Size = 8
            .Caption = "Topt Frame Work Optional Arguments"
            .width = 396
            .height = 120
            .Top = 136
            .Left = 6
        ...
        With .UserReqLabel1
            ...
            .width = 90
            .Top = 20
            .Caption = "Acquire Instance Name"
            .Visible = True
        End With
        With .UserReqTextBox1
            .width = 150
            .Left = 110
            .Top = 20
            .Visible = True
        ...
        With .UserReqLabel2
            ...
            .width = 90
            .Top = 50
            .Caption = "User Macro Name"
            .Visible = True
        End With
        With .UserReqTextBox2
            .width = 150
            .Left = 110
            .Top = 50
            .Visible = True
        End With
        With .UserReqEvalLabel1
            .Font.Name = "Tahoma"
            .Font.Size = 8
            .AutoSize = True
