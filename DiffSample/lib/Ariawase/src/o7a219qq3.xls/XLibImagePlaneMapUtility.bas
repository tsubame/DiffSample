Attribute VB_Name = "XLibImagePlaneMapUtility"
Option Explicit
...
Public Sub CreatePlaneMapIfNothing()
    
    If TheIDP.PlaneMapManager.Count = 0 Then
        Call TheIDP.PlaneMapManager.Init
        Call ControlShtFormatColorMap
    End If
